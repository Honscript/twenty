...
import { seedPromotorasAllView } from 'src/engine/workspace-manager/standard-objects-prefill-data/views/promotoras-all.view';
...
export const seedViewWithDemoData = async (
  ...
  const viewDefinitions = [
    ...
    seedPromotorasAllView(objectMetadataStandardIdToIdMap),
